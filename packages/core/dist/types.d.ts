...
export type TransactionStatus = 'pending' | 'approved' | 'rejected' | 'executing' | 'completed' | 'failed' | 'disputed' | 'refunded';
/**
...
export type DisputeStatus = 'open' | 'investigating' | 'resolved_refunded' | 'resolved_denied' | 'resolved_partial' | 'escalated';
/** Who is at fault in a dispute */
export type LiabilityAttribution = 'agent' | 'service_provider' | 'protocol' | 'user' | 'undetermined';
/**
...
export type AlertType = 'budget_threshold' | 'anomaly_detected' | 'rate_spike' | 'new_recipient' | 'large_transaction' | 'policy_violation';
/**
